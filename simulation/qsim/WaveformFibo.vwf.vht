...
-- *****************************************************************************
-- Generated on "12/13/2022 05:33:34"
...
SIGNAL out_br_regA : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL out_br_regB : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL out_endereco : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL out_opcode : STD_LOGIC_VECTOR(3 DOWNTO 0);
SIGNAL out_out_mult4_2X1_ram_ula : STD_LOGIC_VECTOR(7 DOWNTO 0);
...
LOOP
	...
	clock <= '1';
	WAIT FOR 5000 ps;
	IF (NOW >= 900000 ps) THEN WAIT; END IF;
END LOOP;
